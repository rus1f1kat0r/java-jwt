package com.lyft.android.auth0.jwt.interfaces;
...
interface KeyProvider<U extends PublicKey, R extends PrivateKey> {
     ...
     *
     * @param keyId the Key Id specified in the Token's Header or null if none is available. Provides a hint on which Public Key to use to
