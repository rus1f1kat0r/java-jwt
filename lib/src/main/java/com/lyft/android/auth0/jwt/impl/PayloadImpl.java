...
import static com.lyft.android.auth0.jwt.impl.JsonNodeClaim.extractClaim;
...
class PayloadImpl implements Payload, Serializable {
    ...
    PayloadImpl(String issuer, String subject, List<String> audience, Date expiresAt, Date notBefore, Date issuedAt, String jwtId,
            Map<String, JsonNode> tree, ObjectReader objectReader) {
        this.issuer = issuer;
