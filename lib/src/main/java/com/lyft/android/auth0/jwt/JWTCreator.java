...
import com.lyft.android.auth0.jwt.exceptions.JWTCreationException;
import com.lyft.android.auth0.jwt.exceptions.SignatureGenerationException;
import com.lyft.android.auth0.jwt.impl.ClaimsHolder;
import com.lyft.android.auth0.jwt.impl.PayloadSerializer;
...
public final class JWTCreator {
    ...
    public static class Builder {
         ...
         * If the {@link Algorithm} used to sign this token was instantiated with a KeyProvider, the 'kid' value will be taken from that
    ...
    private String sign() throws SignatureGenerationException {
        String header =
                Base64.encodeToString(headerJson.getBytes(StandardCharsets.UTF_8), Base64.URL_SAFE | Base64.NO_PADDING | Base64.NO_WRAP);
        String payload =
                Base64.encodeToString(payloadJson.getBytes(StandardCharsets.UTF_8), Base64.URL_SAFE | Base64.NO_PADDING | Base64.NO_WRAP);
