...
import com.lyft.android.auth0.jwt.exceptions.JWTVerificationException;
...
/**
 * The JWTVerifier class holds the verify method to assert that a given Token has not only a proper JWT format, but also it's signature
 * matches.
 * <p>
 * This class is thread-safe.
 */
@SuppressWarnings("WeakerAccess")
public final class JWTVerifier implements com.lyft.android.auth0.jwt.interfaces.JWTVerifier {
     ...
     * @throws AlgorithmMismatchException if the algorithm stated in the token's header it's not equal to the one defined in the {@link
     * JWTVerifier}.
